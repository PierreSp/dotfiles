...
run_once({"sh ~/scripts/caps_lock.sh"})
...
local modkey       = "Mod4"
local altkey       = "Mod1"
local terminal     = os.getenv("TERMINAL") or "kitty" or "lxterminal"
local editor       = "nvim"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,           }, "F3", function () awful.spawn(filemanager)            end,
              {description = "launch filemanager", group = "launcher"}),
    awful.key({ modkey,           }, "e", function () awful.spawn("/usr/bin/emacsclient -c")            end,
